  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-2 flex-wrap gap-4">
        ...
        <Link
          href="/events/new"
          className="px-5 py-2 bg-[#09419b] text-white rounded-lg hover:bg-[#09419b] transition text-sm font-semibold"
        >
          ...
          {events.map((ev) => {
            ...
            return (
              <div key={ev.id} className="bg-white dark:bg-gray-800 rounded-lg shadow p-5 flex flex-col">
                ...
                {hasPhotos && (
                  <p className="text-xs text-[#f0bf38] font-semibold mb-3">
                    ✓ {t("photographer.opportunities.hasPhotos")}
                  </p>
                )}
                <Link
                  href={`/upload?eventId=${ev.id}`}
                  className="mt-auto text-center px-4 py-2 bg-[#09419b] text-white rounded-lg hover:bg-[#09419b] text-sm font-semibold transition"
                >
