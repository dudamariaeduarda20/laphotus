    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-950 dark:to-gray-900">
      ...
      <section className="relative overflow-hidden text-white py-24" style={{ background: "linear-gradient(135deg, #09419b 0%, #8B5CF6 50%, #06B6D4 100%)" }}>
        ...
        <div className="relative max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-5xl sm:text-6xl font-bold mb-6 leading-tight">{t("landing.photographer.final.title")}</h2>
          <p className="text-lg sm:text-xl text-white/90 mb-10">{t("landing.photographer.final.subtitle")}</p>
          <Link
            href="/auth/register?type=fotografo"
